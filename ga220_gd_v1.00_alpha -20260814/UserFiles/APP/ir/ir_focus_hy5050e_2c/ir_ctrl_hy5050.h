...
*HISTORY:
*==============================================================*/
uint8_t Ir_process_data_send(IR_DATA_SEND_TYPE send_type,uint8_t *data,uint8_t data_len);
/*==============================================================
*FUNCTION NAME:
*DISCRIPTION:
*PARAMETERS:send_type:指令类型
...
void ir_process_data_in(uint8_t *data,uint32_t length);
