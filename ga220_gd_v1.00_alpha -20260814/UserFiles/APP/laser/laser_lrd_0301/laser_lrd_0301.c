...
*==============================================================*/
#if LASER_LRD_0301
#include "APP/laser/laser_lrd_0301/laser_lrd_0301.h"
#include "Common/config.h"
#include "Bsp/SEGGER_RTT.h"

static uint8_t start_cmd[6]={0x5A,0x0A,0x02,0x02,0x00,0xF1};
static uint8_t stop_cmd[6]={0x5A,0x0A,0x02,0x00,0x00,0xF3};
COM_RECV_INFO_T laser_serial_rcv_buf;

uint8_t lrd_send_buf[6] = {0};
